...
public class TrailersFirebaseJobService extends JobService {

    private AsyncTask<Void, Void, Void> mFetchTrailersTask;

    @Override
    public boolean onStartJob(final JobParameters jobParameters) {

        mFetchTrailersTask = new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(Void... voids) {
                Context context = getApplicationContext();
                AppSyncTask.syncTrailers(context);
                return null;
            }
